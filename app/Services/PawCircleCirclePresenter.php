...
final class PawCircleCirclePresenter
{
    ...
    private function collections(
        ...
        return [
            $this->collection(
                ...
                actionRoute: 'pet-social.preview',
            ...
            $this->collection(
                ...
                actionRoute: 'pet-social.neighbors.index',
            ...
            $this->collection(
                ...
                actionRoute: 'pet-social.groups.index',
            ...
            $this->collection(
                ...
                actionRoute: 'pet-social.meetups.index',
    ...
    private function starterItems(array $posts, array $neighbors, array $meetups): array
    {
        return [
            ...
            [
                ...
                'route' => 'pet-social.neighbors.index',
                'icon' => 'user-plus',
            ],
            [
