...
final class PawCircleGroupPresenter
{
    public function __construct(
        private readonly PawCircleGroupCatalog $catalog,
        private readonly PawCircleGroupContentCatalog $content,
        private readonly PawCircleGroupState $state,
