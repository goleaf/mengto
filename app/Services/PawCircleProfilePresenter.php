...
final class PawCircleProfilePresenter
{
    public function __construct(
        private readonly PawCirclePrototypeState $state,
        private readonly PawCircleProfileVisibility $visibility,
        private readonly PawCircleInteractionPresenter $interactions,
        private readonly PawCirclePetProfileCatalog $pets,
        private readonly PawCircleCreatedContentPresenter $created,
        private readonly PawCirclePetFriendCatalog $friendPets,
    ) {}
