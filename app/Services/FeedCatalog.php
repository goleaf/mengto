...
final class FeedCatalog
{
    ...
    {
        return [
            $this->story('Scout', 'Park loop', 'photo-1654256578072-b932c33cb92e', 'pets.scout', true),
            $this->story('Nori', 'Window watch', 'photo-1518791841217-8f162f1e1131', 'pets.nori', true),
            $this->story('Mochi', 'Cafe win', 'photo-1769635325695-dead509dc5b3', 'neighbors.ari'),
