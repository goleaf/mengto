...
final class PawCircleEventPresenter
{
    public function __construct(
        private readonly PawCircleEventCatalog $catalog,
        private readonly PawCircleEventContentCatalog $content,
        private readonly PawCircleEventState $state,
