...
final class PreviewService
{
    ...
    public function discoverData(): array
    {
        ...
        return [
            'owner' => $this->owner(),
            'summary' => [
                'eyebrow' => __('messages.local_discovery_d15b1c4766'),
                'title' => __('messages.find_your_next_pet_friendly_plan_a99534715d'),
                'description' => __('messages.a_focused_mix_of_nearby_pets_people_walks_and_circles_th_b69cddf444'),
                'count' => __('messages.4_top_matches_7727d0a595'),
            ],
            'query' => [
                'label' => __('messages.showing_matches_for_64aece1e46'),
                'text' => __('messages.calm_weekend_walks_2b99549088'),
                'location' => __('messages.richmond_within_5_miles_8870fa16c7'),
            ],
            'filters' => $this->filterOptions([
                'top-matches' => __('messages.top_matches_ca85a90f5c'),
                'pets' => __('messages.pets_7dc1cd7eaf'),
                'people' => __('messages.people_7db2089705'),
                'meetups' => __('messages.meetups_ce225ab027'),
                'groups' => __('messages.groups_39bbb719fa'),
            ]),
            'results' => [
                [
                    'kind' => __('messages.pet_8f0d1b30eb'),
                    'title' => $pets[__('messages.scout_8a1db462be')]['name'],
                    'meta' => $pets[__('messages.scout_8a1db462be')]['breed'].' · '.$pets[__('messages.scout_8a1db462be')]['neighborhood'],
                    'description' => $pets[__('messages.scout_8a1db462be')]['status'].'. A bright, social companion who likes focused games and roomy park loops.',
                    'detail' => __('presentation.age_with_owner', [
                        'age' => $pets[__('messages.scout_8a1db462be')]['age'],
                        'owner' => $pets[__('messages.scout_8a1db462be')]['owner'],
                    ]),
                    'image' => $pets[__('messages.scout_8a1db462be')]['image'],
                    'image_small' => $pets[__('messages.scout_8a1db462be')]['image_small'],
                ...
                [
                    'kind' => __('messages.neighbor_03385f7343'),
                    ...
                    'detail' => trans_choice(
                        'presentation.mutual_neighbors',
                        $neighbors['ari']['mutual_count'],
                        ['count' => $neighbors['ari']['mutual_count']],
                    ),
                ...
                [
                    'kind' => __('messages.meetup_b8e99f52bc'),
                ...
                [
                    'kind' => __('messages.group_34ca0e7660'),
            ...
            'pulse' => [
                ['label' => __('messages.walk_plans_64510c27c8'), 'value' => '27', 'detail' => __('messages.this_week_7d76655e72')],
                ['label' => __('messages.fresh_posts_8c1d707219'), 'value' => '14', 'detail' => __('messages.near_richmond_bb4b726c5d')],
                ['label' => __('messages.new_neighbors_870a64030f'), 'value' => '9', 'detail' => __('messages.within_5_miles_dbb33bab7c')],
            ],
            'trending' => [
                ['topic' => __('messages.shaded_summer_routes_bd787065e8'), 'category' => __('messages.walks_22e4ca854b'), 'count' => __('messages.46_posts_21eaef0615')],
                ['topic' => __('messages.calm_dog_introductions_3915d47d8f'), 'category' => __('messages.care_4262074d6c'), 'count' => __('messages.31_posts_74cec9840f')],
                ['topic' => __('messages.indoor_cat_enrichment_539ac8d73f'), 'category' => __('messages.cats_ec05d70c6f'), 'count' => __('messages.28_posts_93658c5b97')],
                ['topic' => __('messages.foster_supply_swaps_062e57e65b'), 'category' => __('messages.community_bb501d7877'), 'count' => __('messages.19_posts_fbf52a8674')],
            ],
            'weekend' => [
                'eyebrow' => __('messages.this_weekend_d8aa850259'),
                'title' => $meetups['small-dog-social']['title'],
                'date' => $meetups['small-dog-social']['date_label'].' · '.$meetups['small-dog-social']['time'],
                'datetime' => $meetups['small-dog-social']['datetime'],
                'date_accessible' => $meetups['small-dog-social']['date_accessible'],
