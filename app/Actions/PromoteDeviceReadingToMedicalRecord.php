        ...
        return DB::transaction(function () use ($device, $reading): Model {
            ...
            if ($locked->smart_device_id !== $device->id) {
                throw ValidationException::withMessages([
                    'reading' => 'This reading does not belong to the selected device.',
                ]);
            }
            ...
            if ($locked->pet_profile_key === null) {
                throw ValidationException::withMessages([
                    'reading' => 'Choose the pet before adding this shared-device reading.',
                ]);
            }
            ...
            if ($record === null) {
                throw ValidationException::withMessages([
                    'reading' => 'Create this pet’s health record before adding the reading.',
                ]);
            }
            ...
            if (
                ...
                $entry = $this->createMedicalEntry->handle($record, [
                    ...
                    'measurement_context' => 'Connected device; owner promoted for review.',
                    'notes' => 'Non-clinical device reading. Confirm calibration and conditions.',
                ]);
            ...
            $entry = $this->createMedicalEntry->handle($record, [
                ...
                'next_step' => 'Verify the device, context, and interpretation with a veterinarian.',
                'is_critical' => false,
            ]);
