...
| Discovery | Enter from primary navigation, scan bounded recommendations with factual reasons, narrow by validated query/category, open the canonical module, hide an item/category, and reset user-owned preferences |
