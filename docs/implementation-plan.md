...
Status: `Prompt 04 resumable Livewire wizard approved and test-first
implementation starting on the reviewed Prompt 02/03 foundation; complete
onboarding and repository release remain unclaimed` on 2026-08-30.
