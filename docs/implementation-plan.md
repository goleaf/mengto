...
Status: `Prompt 03 authentication/portal-boundary integration implemented and
focused-verified on the reviewed Prompt 02 state foundation; repository
release remains NO-GO` on 2026-08-30.
