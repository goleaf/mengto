...
| --- | --- | --- | --- |
| REQDOC-CP-01 | Discovery | Instruction chain loaded; current Git baseline captured; all seven reports reconciled and material claims reproduced | Complete |
