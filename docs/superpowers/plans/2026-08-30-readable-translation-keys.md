...
- [ ] **Step 3: Add the architecture ratchet**
...
- [ ] **Step 2: Replace both digest generators**
...
- [ ] **Step 3: Run GREEN for the helper without weakening the catalogue RED**
...
- [ ] **Step 1: Implement migration preflight and mapping**
...
- [ ] **Step 2: Implement exact reference and catalogue rewriting**
...
- [ ] **Step 3: Observe migration check RED**
...
- [ ] **Step 4: Execute the migration and inspect counts**
...
- [ ] **Step 2: Run source and formatting gates**
