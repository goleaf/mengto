...
return [
    ...
    'messages' => [
        ...
        'case_closed' => 'The moderation case was closed.',
    ...
    'validation' => [
        ...
        'case_already_closed' => 'This moderation case is already closed.',
        'case_resolution_required' => 'Resolve the moderation case before closing it.',
        'case_version_conflict' => 'This moderation case changed. Reload it before closing.',
        'closure_idempotency_key_conflict' => 'This closure request identifier has already been used.',
        'invalid_closure_idempotency_key' => 'Provide a valid closure request identifier.',
