    ...
    <div class="mx-auto grid w-full max-w-6xl gap-7 care-report">
        <header class="care-report__header">
            <div>
                <a href="{{ $care_journal['show_url'] }}" class="care-report__back">
                    ...
                    {{ __('ui.return_to_journal') }}
                </a>
                <p class="mt-5 text-sm font-bold uppercase text-paw-leaf">{{ __('ui.private_care_report') }}</p>
            ...
            <button type="button" class="action action--primary" data-print-page>
                ...
                <span>{{ __('ui.print_or_save_pdf') }}</span>
            </button>
        </header>
        ...
        <section class="care-section" aria-labelledby="report-summary-title">
            <div class="care-section__heading">
                <div>
                    <p class="text-xs font-bold uppercase text-paw-leaf">{{ __('ui.recorded_routine') }}</p>
                    <h2 id="report-summary-title" class="mt-1 text-xl font-bold">{{ __('ui.period_table') }}</h2>
                </div>
            </div>
        ...
        <section class="care-section" aria-labelledby="report-timeline-title">
            <div class="care-section__heading">
                <div>
                    <p class="text-xs font-bold uppercase text-paw-leaf">{{ __('ui.source_preserving_history') }}</p>
                    <h2 id="report-timeline-title" class="mt-1 text-xl font-bold">{{ __('ui.detailed_timeline') }}</h2>
                </div>
            </div>
