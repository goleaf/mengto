...
<x-object.directory-card data-directory-pet {{ $attributes }}>
    <x-slot:media>
        <x-ui.card-media
            :src="$pet['image']"
            ...
            ratio="portrait"
        >
            <x-object.pet-badge :type="$pet['species']" class="absolute right-3 top-3" />
        </x-ui.card-media>
    </x-slot:media>
    ...
    <x-ui.tag-list :items="$pet['traits']" empty="No traits shared." reserve class="mt-4" />
