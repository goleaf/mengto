...
>
    ...
    <div class="detail-hero__body">
        <div class="detail-hero__heading-row">
            <x-object.detail-identity :detail="$detail" />
        ...
        <x-object.detail-meta-list :items="$detail['meta']" />

        <x-ui.tag-list :items="$detail['tags']" empty="No topics listed." roomy class="detail-hero__tags" />
