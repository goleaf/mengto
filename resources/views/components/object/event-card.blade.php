...
<article class="event-card">
    ...
    >
        ...
        <span class="event-card__badges">
            ...
            @if ($event['commercial_label'] ?? null)
                <x-ui.status-badge :label="$event['commercial_label']" tone="surface" />
            @endif
        </span>
    </a>
    ...
    <div class="event-card__body">
        ...
        <x-ui.tag-list :items="$event['tags']" empty="No event tags." class="event-card__tags" />

        <div class="event-card__footer">
            <div class="event-card__organizer">
                <x-ui.initials-avatar :initials="$event['organizer_initials']" tone="mint" />
                <div>
                    <p>{{ $event['organizer'] }}</p>
