...
<div class="event-directory">
    ...
    @if ($events['view'] === 'calendar')
        <x-content-panel section="event-calendar" eyebrow="Calendar" title="Upcoming dates">
    ...
    @elseif ($events['view'] === 'map')
        <x-content-panel section="event-map" eyebrow="Generalized locations" title="Events on the map">
