...
<article role="listitem" data-profile-pet class="pc-panel pc-panel--clip grid sm:grid-cols-[10rem_minmax(0,1fr)]">
    ...
    <div class="min-w-0 p-4 sm:p-5">
        <div class="flex items-start justify-between gap-3">
            <div class="min-w-0">
                <x-pet-social.pet-badge :type="$pet['species']" tone="mint" />
        ...
        <x-pet-social.tag-list :items="$pet['traits']" empty="No traits shared." class="mt-3" />
    </div>
</article>
