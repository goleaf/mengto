...
@if ($variant === 'mobile')
    <nav {{ $attributes->class(['pc-mobile-dock', 'fixed inset-x-0 bottom-0 z-20 border-t border-paw-line/80 bg-paw-cream/95 px-4 pt-2 backdrop-blur sm:px-6 lg:hidden']) }} aria-label="Mobile preview navigation">
        <div class="pc-mobile-nav__rail">
            @forelse ($items as $item)
                <x-pet-social.mobile-nav-item
