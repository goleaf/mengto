...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="min-h-screen bg-paw-cream text-paw-ink">
            <x-pet-social.site-header :owner="$owner" :active-section="$activeSection" />

            <main id="main-content" class="pc-app-main mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8">
                {{ $slot }}
            </main>

            <x-pet-social.primary-navigation :active-section="$activeSection" variant="mobile" />
        </div>
    </body>
</html>
