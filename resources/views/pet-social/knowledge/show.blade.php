<x-layout.app-shell :owner="$owner" :title="$page_title" :active-section="$active_section">
    <div class="forum-page">
        <nav class="forum-filter-tabs" aria-label="Breadcrumb">
            <a href="{{ route('pet-social.knowledge.index') }}">
                <x-lucide-arrow-left aria-hidden="true" />
                Knowledge base
            </a>
            <a href="{{ route('pet-social.forum.index', ['category' => $article['category']]) }}">Related forum topics</a>
        </nav>
            ...
            <aside class="forum-sidebar">
                ...
                @if ($article['source_topic'])
                    <section class="forum-sidebar__section">
                        ...
                        <div class="forum-mini-list">
                            <a href="{{ route('pet-social.forum.topics.show', $article['source_topic']['slug']) }}">
                ...
                <section class="forum-sidebar__section">
                    <details>
                        ...
                        <form method="POST" action="{{ route('pet-social.knowledge.corrections.store', $article['slug']) }}" class="forum-form mt-2">
                            @csrf
                ...
                <section class="forum-sidebar__section">
                    ...
                    <div class="forum-mini-list">
                        @forelse ($related as $relatedArticle)
                            <a href="{{ route('pet-social.knowledge.articles.show', $relatedArticle['slug']) }}">
